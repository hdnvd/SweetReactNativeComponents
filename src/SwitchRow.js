...
import {Text, View, Image, Switch, Dimensions, StyleSheet} from 'react-native';
    ...
    render() {
        return (
            <View style={this.props.style!=null?this.props.style:Styles.row} flexDirection={'row-reverse'}>
                ...
                <Switch style={this.props.contentStyle!=null?this.props.contentStyle:Styles.content} value={this.props.content}/>
            </View>);
    }
}
